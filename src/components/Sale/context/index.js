...
function SaleProvider({ children }) {
  ...
  const { handleSaveSaleAndSaleBills, addBillToList, confirmRemoveBill, handleChangeConfirmRemoveBill, handleRemoveBillInTableAndBillSale, cancelRemoveBill, handleChangeBill } = UseBill()
  ...
  return (
    <SaleContext.Provider value={{
     ...
     /*UseBill*/ handleSaveSaleAndSaleBills, addBillToList, confirmRemoveBill, handleChangeConfirmRemoveBill, handleRemoveBillInTableAndBillSale, cancelRemoveBill, handleChangeBill
    }}>
      {children}
