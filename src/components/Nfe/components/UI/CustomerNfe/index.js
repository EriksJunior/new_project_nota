...
export function CustomertNfe() {
  const { customersFromSelectBox, customer, handleChangeCustomerAndList } = useContext(LeafContext)
      ...
      <div className="card-body">
        ...
        <div className="row col-sm-12 col-md-12 col-lg-12 col-xl-12">
          <div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
            ...
            <select className="form-select form-select-sm" name="id" value={customer.idCliente} onChange={handleChangeCustomerAndList}>
