...
export function ProductNfe() {
  const { productsFromSelectBox, addProducts, removeProduct, handleChangeProducts, handleSaveLeaf } = useContext(LeafContext)
        ...
        <Scrollllll>
          <ContentTable>
            ...
            <ContentButtonAddMoreItems>
              ...
              <button className="btn btn-primary btn-sm" onClick={handleSaveLeaf}>Salvar</button>
            </ContentButtonAddMoreItems>
          </ContentTable>
        </Scrollllll>
