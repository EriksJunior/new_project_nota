...
function LeafProvider({ children }) {
  ...
  const { getProcuctsFromSelectBox, productsFromSelectBox, addProducts, removeProduct, handleChangeProducts, saveLeafProducts } = UseProduct()
  ...
  return (
    <LeafContext.Provider value={{
     ...
     /*UseProduct*/ getProcuctsFromSelectBox, productsFromSelectBox, addProducts, removeProduct, handleChangeProducts, saveLeafProducts
    }}>
      {children}
