...
function LeafProvider({ children }) {
  ...
  return (
    <LeafContext.Provider value={{
     ...
     /*UseLeaf*/ handleChangePedido, handleSaveLeaf, handleChangeFreightAndOthers, calculateTotalLeafBasedProducts, calculateTotalDiscountLeaf, refValorTotalPedido, refTotalDescontoPedido, openModal, setOpenModal, openModalCancelLeaf, setOpenModalCancelLeaf, openModalReturnedLeaf, setOpenModalReturnedLeaf, handleSendLeafAndFind, cancelLeaf, enbleModalCancelLeaf, enbleModalReturnedLeaf, searchLeaf, dataSearchLeaf, handleNewLeaf, switchBetweenComponents, handleEditLeaf, openLayouts, openAreaLeaf, refDescriptionCancelLeaf, clearAllInputs,
