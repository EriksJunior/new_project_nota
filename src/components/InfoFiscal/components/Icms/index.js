  ...
  return (
    <Div className="row">
      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <Select name="tipo_tributacao" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].tipo_tributacao}>
      ...
      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <Select name="cenario" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].cenario}>
          {cenario.map((cen) =>
      ...
      <Div className="mb-3 col-sm-4 col-md-3 col-lg-3 col-xl-3">
        ...
        <Select name="tipo_pessoa" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].tipo_pessoa}>
      ...
      <DivContentCheckBox className="mb-3 col-sm-8 col-md-9 col-lg-9 col-xl-9 form-check" >
        <Input name="nao_contribuinte" className="form-check-input" type="checkbox" defaultChecked={infoFiscale.icms[0].nao_contribuinte} defaultValue={infoFiscale.icms[0].nao_contribuinte} id="flexCheckIndeterminate" />
      ...
      <Div className="mb-3 col-sm-4 col-md-4 col-lg-4 col-xl-4">
        ...
        <Input name="codigo_cfop" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].codigo_cfop} />
      </Div>

      <Div className="mb-3 col-sm-8 col-md-8 col-lg-8 col-xl-8">
        <Label className="form-label">Situação tributária</Label>
        <Select name="situacao_tributaria" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].situacao_tributaria}>
      ...
      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <Input name="aliquota_diferimento" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].aliquota_diferimento} />
      </Div>

      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <Label className="form-label">Alíquota do diferimento ICMS (FCP) %</Label>
        <Input name="aliquota_diferimento_fcp" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].aliquota_diferimento_fcp} />
      </Div>

      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <Label className="form-label">Alíquota MVA: Estado</Label>
        <Select name="estado" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].aliquota_mva[0].estado}>
      ...
      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <Input name="aliquota" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].aliquota_mva[0].aliquota} />
      </Div>

      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <Label className="form-label">Alíquota da redução da base de cálculo ICMS %</Label>
        <Input name="aliquota_reducao" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].aliquota_reducao} />
      </Div>

      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <Label className="form-label">Alíquota da redução da base de cálculo ICMS-ST %</Label>
        <Input name="aliquota_reducao_st" type="text" className="form-control form-control-sm" defaultValue={infoFiscale.icms[0].aliquota_reducao_st} />
      </Div>

      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        <Label className="form-label">Motivo da Desoneração do ICMS</Label>
        <Select name="motivo_desoneracao" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].motivo_desoneracao}>
      ...
      <Div className="mb-3 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <Select name="motivo_desoneracao_st" className="form-select form-select-sm" defaultValue={infoFiscale.icms[0].motivo_desoneracao_st}>
